...
##### 👨‍💻 I have managed to know and really put in practice:
...
##### I have made actions in the cloud with:
...
###### And also these are the languagues i have learned in the past but decided to not use (could be optional if the time's right!):
